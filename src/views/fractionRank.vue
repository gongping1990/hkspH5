      ...
      <div class="p-fractionRank-body">
        <div class="-body-top">
          <div class="-body-top-one">
            <img v-if="dataItemTwo"
                 class="-img"
                 :src="dataItemTwo.headimgurl"
            />
            <div class="-name">{{dataItemTwo.nickName}}</div>
            <div class="-num" v-if="dataItemTwo">{{dataItemTwo.creditAmount}}分</div>
          </div>
          <div class="-body-top-two">
            <img v-if="dataItemOne"
                 class="-img"
                 :src="dataItemOne.headimgurl"
            />
            <div class="-name">{{dataItemOne.nickName}}</div>
            <div class="-num" v-if="dataItemOne">{{dataItemOne.creditAmount}}分</div>
          </div>
          <div class="-body-top-three">
            <img v-if="dataItemThree"
                 class="-img"
                 :src="dataItemThree.headimgurl"
            />
            <div class="-name">{{dataItemThree.nickName}}</div>
            <div class="-num" v-if="dataItemThree">{{dataItemThree.creditAmount}}分</div>
          </div>
        </div>
        <div class="-body-down">

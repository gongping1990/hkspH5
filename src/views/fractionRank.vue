  ...
  <div class="p-fractionRank">
    <div class="p-fractionRank-header">
      ...
      <div class="-header-tab">
        <div class="-header-tab-btn" :class="{'-active':tabIndex=='1'}" @click="changeTab">总榜</div>
        <div class="-header-tab-btn" :class="{'-active':tabIndex=='2'}" @click="changeTab">周榜</div>
      </div>
    </div>
    <van-list class="p-fractionRank-content"
              :finished="finished"
              finished-text="没有更多了"
              @load="onLoad">
      <div class="p-fractionRank-body">
        <div class="-body-top">
          <div class="-body-top-one">
            <img class="-img" src="https://pub.file.k12.vip/2019/05/08/1126029495313874946.jpg"/>
            <div class="-name">飞向企鹅的猪</div>
            <div class="-num">385分</div>
          </div>
          <div class="-body-top-two">
            <img class="-img" src="https://pub.file.k12.vip/2019/05/08/1126029350438039554.jpg"/>
            <div class="-name">最美的期待</div>
            <div class="-num">585分</div>
          </div>
          <div class="-body-top-three">
            <img class="-img" src="https://pub.file.k12.vip/2019/05/08/1126029616962015234.jpg"/>
            <div class="-name">最美的期待</div>
      ...
      <div class="p-fractionRank-footer">
        <div class="-footer-myself">
          <div class="-footer-myself-left">
            ...
            <div class="-myself-img">
              <img src="https://pub.file.k12.vip/2019/05/08/1126023000735739906.jpg"/>
            </div>
        ...
        <div class="-footer-item" v-for="(item,index) of dataList" :key="index">
          <div class="-footer-item-left">
            <div class="-item-num" v-if="index>2">{{item.rank}}</div>
            <img class="-item-rank-img" src="../assets/image/fuli/first.png" v-if="index==0"/>
            <img class="-item-rank-img" src="../assets/image/fuli/secend.png" v-if="index==1"/>
            <img class="-item-rank-img" src="../assets/image/fuli/third.png" v-if="index==2"/>
            <div class="-item-img">
              <img :src="item.url"/>
            </div>
  ...
  .p-fractionRank {
    ...
    &-body {
      ...
      .-body-top {
        ...
        background: url("../assets/image/fuli/ranking list-backgroud.png") no-repeat;
        background-size: 100%;
        height: 277px;

  ...
  <div class="p-welfareCentre">
    ...
    <div class="p-welfareCentre-swipe">
      <div class="-swipe-item">
        <van-swipe class="-swipe-item-wrap" :show-indicators="false" :autoplay="3000" vertical>
          <van-swipe-item class="-swiper-flex" v-for="(item,index) of dataDetail.convertMsgs" :key="index">
    ...
    <div class="p-welfareCentre-sign">
      ...
      <div class="-sign-top">
        <div class="-sign-width">
          ...
          <div class="-time">
            <span class="-num">{{dataDetail.myCredit.learnTime}}</span>分钟
          </div>
        </div>
        <div class="-sign-width">
    ...
    <div class="p-welfareCentre-rank">
      ...
      <div class="p-welfareCentre-rank-down">
        ...
        <div class="-item-down-wrap">
          <div class="-item-down" v-for="(item,index) of rankList" :key="index">
            <img :src="item.headimgurl"/>
          </div>
        </div>
        <div class="-ellipsis" v-if="rankList.length>5">...</div>
      ...
      <div class="p-welfareCentre-rank-num">
        <div class="-num-text">已经有<span>{{tab.total}}位</span>家长加入赚取学分</div>
    ...
    <div class="p-welfareCentre-prize">
      ...
      <div class="p-welfareCentre-prize-wrap">
        <div class="-prize-item" v-for="(item,index) of prizeList" :key="index">
          ...
          <div class="-btn" :class="{'-btn-out': index==2}" @click="toExchange(item)">
            {{item.credit}}积分兑换
          </div>
        </div>
      </div>

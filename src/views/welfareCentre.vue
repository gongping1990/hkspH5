    ...
    <div class="p-welfareCentre-sign">
      ...
      <div class="-sign-bottom">
        ...
        >
          ...
          <img
                  class="-two -animation"
                  v-if="isTimeToCollectThree && !dataDetail.myCredit.getCreditLearnThree"
        ...
        >
          ...
          <img
                  class="-two -animation"
                  v-if="isTimeToCollectFive && !dataDetail.myCredit.getCreditLearnFive"
                  src="../assets/image/fuli/button-coin-pre.png"
        ...
        >
          <div
                  class="-one"
                  v-if="
              dataDetail.myCredit.getCreditLearnTen && !isTimeToCollectTen
            "
          >
            +300
          </div>

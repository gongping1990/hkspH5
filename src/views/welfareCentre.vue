      ...
      <div class="-sign-bottom">
        ...
        >
          <div
            class="-one"
            v-if="
              dataDetail.myCredit.getCreditLearnThree && !isTimeToCollectFive
            "
          >
            +200
          </div>
        ...
        >
          <div
            class="-one"
            v-if="
              dataDetail.myCredit.getCreditLearnThree && !isTimeToCollectTen
            "
          >
            +300
          </div>

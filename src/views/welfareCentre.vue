  ...
  <div class="p-welfareCentre">
    ...
    <div class="p-welfareCentre-swipe">
      <div class="-swipe-item">
        <van-swipe class="-swipe-item-wrap" :show-indicators="false" :autoplay="3000" vertical>
          <van-swipe-item class="-swiper-flex" v-for="(item,index) of broadcastList" :key="index">
            <img class="-swipe-item-headimg"
                 :src="item.url"/>
    ...
    <div class="p-welfareCentre-sign">
      <div class="-sign-img">
        <img v-if="!isSign" @click="toSign" class="-btn-img-center" src="../assets/image/fuli/button-sign.png">
        <img v-if="isSign" @click="toSign" class="-btn-img-center" src="../assets/image/fuli/button-sign in.png">
      </div>
      ...
      <div class="-sign-bottom">
        ...
        <div class="-sign-bottom-wrap -sign-bottom-wrap-two">
          <img class="-two -animation" src="../assets/image/fuli/button-coin-pre.png"/>
    ...
    <div class="p-welfareCentre-rank">
      ...
      <div class="p-welfareCentre-rank-top">
        <div class="-item-wrap" v-for="(item,index) of rankList" :key="index">
          <img v-if="index==0" class="-item-icon" src="../assets/image/fuli/first.png"/>
          <img v-if="index==1" class="-item-icon" src="../assets/image/fuli/secend.png"/>
          <img v-if="index==2" class="-item-icon" src="../assets/image/fuli/third.png"/>
          <div class="-item-head"
      ...
      <div class="p-welfareCentre-rank-down">
        ...
        <div class="-item-down-wrap">
          <div class="-item-down" v-for="(item,index) of 6" :key="index">
            <img src="https://wx.qlogo.cn/mmopen/vi_32/DYAIOgq83epxBOwIsH1se324kFtXjDgaj6DzpsF162VlbsWrq01HOGSia5Qpe3toQroxwdwTHxv3DXKqxTVSrmA/132"/>
          </div>
        </div>
        <div class="-ellipsis">...</div>
      </div>
      ...
      <div class="p-welfareCentre-rank-user">
        <div class="-user-wrap">
          ...
          <div class="-user-img"><img src="https://wx.qlogo.cn/mmopen/vi_32/DYAIOgq83epxBOwIsH1se324kFtXjDgaj6DzpsF162VlbsWrq01HOGSia5Qpe3toQroxwdwTHxv3DXKqxTVSrmA/132"/></div>
      ...
      <div class="p-welfareCentre-prize-wrap">
        <div class="-prize-item" v-for="(item,index) of 10" :key="index">
          <div class="-img" @click="toInfo">
            <img src="https://pub.file.k12.vip/2019/05/07/1125702765063303170.png">
          </div>
          <div class="-img-out" v-if="index==2">已抢光</div>
          <div class="-title">腾讯视频季度会员（尊享版）</div>
          <div class="-price">原价：98元</div>
          <div class="-btn" :class="{'-btn-out': index==2}" @click="toExchange">
            7500积分兑换
          </div>
        </div>
      </div>
  ...
  export default {
    ...
    data() {
      return {
        broadcastList: [
          {
            url: 'https://wx.qlogo.cn/mmopen/vi_32/DYAIOgq83epxBOwIsH1se324kFtXjDgaj6DzpsF162VlbsWrq01HOGSia5Qpe3toQroxwdwTHxv3DXKqxTVSrmA/132',
            name: '我是一只猪',
